...
if "Windows" in platform.system():
    ...
    if "32bit" in platform.architecture():
        ...
        miniconda_installer_url = "http://repo.continuum.io/miniconda/Miniconda2-latest-Windows-x86.exe"
    elif "64bit" in platform.architecture():
        miniconda_installer = "Miniconda2-latest-Windows-x86_64.exe"
        miniconda_installer_url = "http://repo.continuum.io/miniconda/Miniconda2-latest-Windows-x86_64.exe"
    spec_file = "install.spec.windows"
elif "Linux" in platform.system():
    # Set Linux parameters here
    if '32bit' in platform.architecture():
        miniconda_installer_url = "http://repo.continuum.io/miniconda/Miniconda2-latest-Linux-x86.sh"
        miniconda_installer = "Miniconda2-latest-linux32-install.sh"
    elif '64bit' in platform.architecture():
        miniconda_installer_url = "http://repo.continuum.io/miniconda/Miniconda2-latest-Linux-x86_64.sh"
